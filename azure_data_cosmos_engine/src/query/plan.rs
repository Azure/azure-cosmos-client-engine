...
pub struct QueryPlan {
    #[cfg_attr(feature = "python", pyo3(item("partitionedQueryExecutionInfoVersion")))]
    pub partitioned_query_execution_info_version: usize,
    #[cfg_attr(feature = "python", pyo3(item("queryInfo")))]
    pub query_info: QueryInfo,
    #[cfg_attr(feature = "python", pyo3(item("queryRanges")))]
...
pub struct QueryInfo {
    #[cfg_attr(feature = "python", pyo3(item("distinctType")))]
    ...
    #[cfg_attr(feature = "python", pyo3(item("orderBy"), default))]
    pub order_by: Vec<SortOrder>,
    #[cfg_attr(feature = "python", pyo3(item("orderByExpressions"), default))]
    pub order_by_expressions: Vec<String>,
    #[cfg_attr(feature = "python", pyo3(item("groupByExpressions"), default))]
    pub group_by_expressions: Vec<String>,
    #[cfg_attr(feature = "python", pyo3(item("groupByAliases"), default))]
    pub group_by_aliases: Vec<String>,
    #[cfg_attr(feature = "python", pyo3(default))]
    pub aggregates: Vec<String>,
    #[cfg_attr(feature = "python", pyo3(item("groupByAliasToAggregateType"), default))]
    pub group_by_alias_to_aggregate_type: HashMap<String, String>,
    #[cfg_attr(feature = "python", pyo3(item("rewrittenQuery"), default))]
    pub rewritten_query: String,
    #[cfg_attr(feature = "python", pyo3(item("hasSelectValue"), default))]
    pub has_select_value: bool,
    #[cfg_attr(feature = "python", pyo3(item("hasNonStreamingOrderBy"), default))]
...
pub struct QueryRange {
    pub min: String,
    pub max: String,
    #[cfg_attr(feature = "python", pyo3(item("isMinInclusive")))]
    pub is_min_inclusive: bool,
    #[cfg_attr(feature = "python", pyo3(item("isMaxInclusive")))]
