...
func (p *clientEngineQueryPipeline) ProvideData(data queryengine.QueryResult) error {
	return p.pipeline.ProvideData(data.PartitionKeyRangeID, string(data.Data), data.NextContinuation)
}
